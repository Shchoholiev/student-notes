...
namespace StudentNotes.Infrastructure.DataInitializer
{
    public static class DbInitializer
    {
        public static void Initialize(EFContext context)
        {
            ...
            //var roleStudent = new Role { Name = "Headman" }; ;

            //// * File Notes
            //var filesPhysics = new List<Core.Entities.File>();
            //var filesEnglish = new List<Core.Entities.File>();
            //var filesMath = new List<Core.Entities.File>();
            //var filesHypertext = new List<Core.Entities.File>();
            //var filesProgramming = new List<Core.Entities.File>();

            //// * Notes Types
            //Core.Entities.Type lab;
            //Type practice;
            //Type lecture;
            //Type exam;
            //Type homework;
            ...
            //filesProgramming.Add(new Core.Entities.File
            //{
            //    Name = "ООП програма",
            //    Author = user4,
            //    Type = helperFile,
